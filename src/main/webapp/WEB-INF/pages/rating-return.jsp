                 ...
                 <div class="cart-table table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th class="pro-title">Remark</th>
                            <th class="pro-title">Return</th>
                        </tr>
                        </thead>
                        <tbody id="goods">
                        ...
                        <tr>
                            ...
                            <td class="pro-title"><a href="rating?id=${cart.pid}"><i class="fa fa-tags"></i></a></td>
                            <td class="pro-title"><a href="return?id=${cart.pid}"><i class="fa fa-thumbs-down"></i></a></td>
                        </tr>
                        </s:forEach>
