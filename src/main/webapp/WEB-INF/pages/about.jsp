            ...
            <div class="col-lg-12">
                <div class="page-breadcrumb">
                    <ul class="nav">
                        ...
                        <li><a href="shop" class="active">About Us</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="category-banner-area deal-products p-0">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <a href="shop"><img src="assets/img/home4-deal-product-1.jpg" alt="Banner"></a>
            </div>

            <div class="col-md-4 mt-xs-30">
                <a href="shop"><img src="assets/img/home4-deal-product-2.jpg" alt="Banner"></a>
            </div>

            <div class="col-md-4 mt-xs-30">
                <a href="shop"><img src="assets/img/home4-deal-product-3.jpg" alt="Banner"></a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-12">
                <div class="brand-logo-carousel owl-carousel">
                    ...
                    <div class="single-brand-item">
                        <img src="assets/img/logo-1.png" alt="brand">
                    </div>
                    <!-- Single Brand Logo End -->

                    <!-- Single Brand Logo Start -->
                    <div class="single-brand-item">
                        <img src="assets/img/logo-2.png" alt="brand">
                    </div>
                    <!-- Single Brand Logo End -->

                    <!-- Single Brand Logo Start -->
                    <div class="single-brand-item">
                        <img src="assets/img/logo-3.png" alt="brand">
                    </div>
                    <!-- Single Brand Logo End -->

                    <!-- Single Brand Logo Start -->
                    <div class="single-brand-item">
                        <img src="assets/img/logo-4.png" alt="brand">
                    </div>
                    <!-- Single Brand Logo End -->

                    <!-- Single Brand Logo Start -->
                    <div class="single-brand-item">
                        <img src="assets/img/logo-5.png" alt="brand">
                    </div>
                    <!-- Single Brand Logo End -->

                    <!-- Single Brand Logo Start -->
                    <div class="single-brand-item">
                        <img src="assets/img/logo-6.png" alt="brand">
                    </div>
                    <!-- Single Brand Logo End -->
                </div>
            </div>
                        ...
                        <div class="single-widget-item">
                            ...
                            <div class="widget-body">
                                <ul class="footer-list">
                                    <li><a href="#">Returns</a></li>
                                    <li><a href="#">Order History</a></li>
                                    <li><a href="myaccout">My Account</a></li>
                                    <li><a href="#">Site Map</a></li>
                                    <li><a href="#">Specials</a></li>
                                </ul>
                            </div>
