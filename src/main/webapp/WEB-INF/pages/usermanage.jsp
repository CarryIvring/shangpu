                                    ...
                                    <div class="myaccount-content">
                                        ...
                                        <div class="myaccount-table table-responsive text-center">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                <s:forEach var="user" items="${data.customerList}">
                                                	<tr>
	                                                    <td>${user.id}</td>
	                                                    <td>${user.username}</td>
	                                                    <td>${user.email}</td>
	                                                    ...
	                                                    <s:if test="${user.flag==2}">
	                                                        <td>Block</td>
	                                                    </s:if>
	                                                    <td>${user.createdate}</td>
	                                                    <td><a href="edituser?id=${user.id}"><i class="fa fa-edit"></i></a></td>
	                                                    <td><a href="deleteuser?id=${user.id}"><i class="fa fa-trash-o"></i></a></td>
	                                                    <td>
	                                                    <s:if test="${user.flag==1}">
	                                                        <a href="blockuser?id=${user.id}" class="fa fa-unlock-alt"></a>
	                                                    </s:if>
	                                                    <s:if test="${user.flag==2}">
	                                                        <a href="activeuser?id=${user.id}" class="fa fa-unlock"></a>
	                                                    </s:if>
	                                                    </td>
                                                	</tr>
                                                </s:forEach>
