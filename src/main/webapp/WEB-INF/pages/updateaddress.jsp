    ...
    <div class="container">
        ...
        <div class="row">
            <!-- Checkout Billing Details -->
                <div class="checkout-billing-details-wrap" style="margin: 0 auto;">
                    <h2>Billing Details</h2>
                    <c:form action="SaveAddressUpdate" method="post" modelAttribute="address">
                    <div class="billing-form-wrap">
                    		<c:hidden path="id"/>
                            <div class="single-input-item">
                                <label for="name" class="required">Receiver Name</label>
                                <c:input path="receiver_name"  />
                            </div>
                            ...
                            <div class="single-input-item">
                                ...
                                <c:input path="customer_name" disabled="true" />
                            </div>
