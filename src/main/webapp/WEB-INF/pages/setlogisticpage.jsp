                    ...
                    <div class="main-menu-wrap">
                        <nav class="mainmenu">
                            <ul class="main-navbar clearfix">
                                ...
                                <li><a href="UpdateLogistic"> LogisticManagement</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade show active">
                                    <div class="myaccount-content">
                                        ...
                                        <c:form method="post" action="savelogistic" modelAttribute="logistic">
                                           <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                <s:forEach var="address" items="${addressList}">
                                                	<tr>
                                                	...
                                                	<input type="hidden" name="receiver" value="${address.receiver_name}"/>
                                                	<input type="hidden" name="city" value="${address.city}"/>
                                                	<input type="hidden" name="state" value="${address.state}"/>
                                                	<input type="hidden" name="street" value="${address.street}"/>
                                                	<input type="hidden" name="phone" value="${address.phone}"/>
                                                	<input type="hidden" name="customer" value="${address.customer_name}"/>
                                                </s:forEach>
                                                </tbody>
                                            </table>
