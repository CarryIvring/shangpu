                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="myaccount-tab-menu nav" role="tablist">
                                ...
                                <a href="addressinfo" class="active"><i class="fa fa-map-marker"></i> address</a>

                                <a href="accountinfo"><i class="fa fa-user"></i> Account Details</a>
					        	...
					        	<tr>
					            	...
					            	<s:forEach var="address" items="${data.listAddress}">
							            <tr>
							                ...
							                <s:if test="${address.flag==1}">
		                    				<td><a href="defaultaddress?id=${address.id}" class="btn">Set As Default</a></td>
			                    			</s:if>
			                    			<s:if test="${address.flag==2}">
			                    				<td><a href="normaladdress?id=${address.id}" class="btn">Set As Normal</a></td>
			                    			</s:if>
							                
							                <td style="text-align: center;"><a href="EditAddress?id=${address.id}" class="fa fa-edit"></a></td>
							                <td style="text-align: center;"><a href="deleteaddress?id=${address.id}" class="fa fa-trash"></a></td>
							            </tr>
					            </s:forEach>
