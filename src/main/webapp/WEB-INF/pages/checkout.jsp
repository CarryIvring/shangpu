<%@page import="com.niit.service.CustomerService"%>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="checkout-billing-details-wrap">
                    ...
                    <c:form action="saveaddress" method="post" modelAttribute="address">
                    <div class="billing-form-wrap">
                            <div class="single-input-item">
                                <label for="name" class="required">Receiver Name</label>
                                <c:input path="receiver_name" placeholder="Receiver Name" required="required"  />
                            </div>

                            <div class="single-input-item">
                                <label for="town" class="required">Town / City</label>
                                <c:input path="city" placeholder="Town / City" required="required"  />
                            </div>

                            <div class="single-input-item">
                                <label for="state">State / Divition</label>
                                <c:input path="state" placeholder="State / Divition" required="required"  />
                            </div>
                            
                            <div class="single-input-item">
                                <label for="street-address" class="required">Street address</label>
                                <c:input path="street" placeholder="Street address" required="required"  />
                            </div>

                            <div class="single-input-item">
                                <label for="phone">Phone</label>
                                <c:input path="phone" placeholder="Phone" required="required"  />
                            </div>
                            
                            <div class="single-input-item">
                                <label for="customer_name">Customer Name</label>
                                <c:input path="customer_name" placeholder="Customer Name" required="required"  />
                            </div>
                    ...
                    <table class="table table-bordered">
                    	...
                    	<s:forEach var="address" items="${data.listAddress}">
                    	<tr>
                    		...
                    		<td>${address.customer_name}</td>
                    			<s:if test="${address.flag==1}">
                    				<td>Normal Address</td>
                    			</s:if>
                    			<s:if test="${address.flag==2}">
                    ...
                    <div class="order-summary-content">
                        ...
                        <div class="order-summary-table table-responsive text-center">
                            <table class="table table-bordered">
                                ...
                                <tfoot>
                                	<%String total = (String)request.getSession().getAttribute("price_session"); %>
                                    <tr>
                                        <td>Sub Total</td>
                        ...
                        <div class="order-payment-method">
                            <div class="summary-footer-area">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="terms">I have read and agree to the website </label>
                                </div>

								<div class="single-input-item">
	                                <label for="ordernote">Order Note</label>
	                                <c:textarea path="note" cols="30" rows="3" placeholder="Notes about your order, e.g. special notes for delivery."></c:textarea>
                            	</div>
