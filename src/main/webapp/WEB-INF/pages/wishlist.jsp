            ...
            <div class="col-lg-12">
                ...
                <div class="cart-table table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        <s:forEach var="wish" items="${data.listWish}">
                        	<tr>
	                            <td class="pro-thumbnail"><img class="img-fluid" src="${wish.img}" alt="Product"/></td>
	                            <td class="pro-title">${wish.pname}</td>
	                            <td class="pro-price"><span>${wish.price}</span></td>
	                            <td class="pro-quantity"><span class="text-success">${wish.stock}</span></td>
	                            <td class="pro-subtotal"><a href="addtocart?id=${wish.pid}" class="btn-add-to-cart">Add to Cart</a></td>
	                            <td class="pro-remove"><a href="deletefromwish?id=${wish.wid}"><i class="fa fa-trash-o"></i></a></td>
                       	 	</tr>
                        </s:forEach>
                        </tbody>
                    </table>
