                                    ...
                                    <div class="myaccount-content">
										...
										<div class="myaccount-table table-responsive text-center">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                <s:forEach var="remarkList" items="${remarkList}">
                                                	<tr>
                                                        <td>${remarkList.id}</td>
                                                        <td>${remarkList.pname}</td>
                                                        <td><img alt="" src="${remarkList.pimg}"></td>
                                                        <td>${remarkList.remark}</td>
                                                        <td>${remarkList.customername}</td>
                                                        <td>${remarkList.createdate}</td>
                                                    </tr>
                                                </s:forEach>
