                                    ...
                                    <div class="myaccount-content">
                                        ...
                                        <div class="myaccount-table table-responsive text-center">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                <s:forEach var="order" items="${listOrder}">
                                                	<tr>
	                                                    <td>${order.id}</td>
	                                                    ...
	                                                    <td>${order.note}</td>
	                                                    <td>${order.date}</td>
	                                                    <s:if test="${order.flag==1}">
	                                                        <td>Approved</td>
	                                                    </s:if>
	                                                    <s:if test="${order.flag==2}">
	                                                        <td>Pending</td>
	                                                    </s:if>
	                                                    <s:if test="${order.flag==3}">
	                                                        <td>Rejected</td>
	                                                    </s:if>
	                                                    <td><a href="deleteorder?id=${order.id}"><i class="fa fa-trash-o"></i></a></td>
	                                                   
		                                                    <s:if test="${order.flag==1}">
		                                                        <td><a href="rejectorder?id=${order.id}" class="fa fa-unlock-alt"></a></td>
		                                                    </s:if>
		                                                    <s:if test="${order.flag==2}">
		                                                    	<td>
		                                                    		<a href="rejectorder?id=${order.id}" class="fa fa-unlock-alt"></a>&nbsp;&nbsp;&nbsp;&nbsp;
		                                                    		&nbsp;&nbsp;&nbsp;&nbsp;<a href="approveorder?id=${order.id}" class="fa fa-unlock"></a>
		                                                    	</td>
		                                                    </s:if>
		                                                    <s:if test="${order.flag==3}">
		                                                        <td><a href="approveorder?id=${order.id}" class="fa fa-unlock"></a></td>
		                                                    </s:if>
                                                	</tr>
                                                </s:forEach>
                                                </tbody>
