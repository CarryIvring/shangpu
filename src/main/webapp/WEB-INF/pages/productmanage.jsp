                ...
                <div class="col-md-7 col-lg-6 mt-xs-10">
                    <div class="site-setting-menu">
                        <ul class="nav justify-content-center justify-content-md-end">
                            <li><a href="loginregister">Sign Out</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="myaccount-content">
                                        ...
                                        <div class="myaccount-table table-responsive text-center">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                <s:forEach var="product" items="${data.productList}">
                                                	<tr>
	                                                    <td>${product.id}</td>
	                                                    <td>${product.pname}</td>
	                                                    <td><img style="width: 50px;height: 50px;" alt="" src="${product.img}"></td>
	                                                    <td>${product.price}</td>
	                                                    <td>${product.stock}</td>
	                                                    <td>${product.describe}</td>
	                                                    <td>${product.date}</td>
	                                                    <td><a href="editproduct?id=${product.id}"><i class="fa fa-edit"></i></a></td>
	                                                    <td><a href="deleteproduct?id=${product.id}"><i class="fa fa-trash-o"></i></a></td>
                                                	</tr>
                                                </s:forEach>
                                                </tbody>
                                            </table>
                                            <a href="AddNewProduct" class="btn" >Add New Porduct</a>
                                        </div>
                                    </div>
                                </div>
