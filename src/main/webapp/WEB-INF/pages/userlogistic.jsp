                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="myaccount-tab-menu nav" role="tablist">
                                ...
                                <a href="logisticinfo" class="active"><i class="fa fa-truck"></i> Logistic</a>
                                    ...
                                    <div class="myaccount-content">
										...
										<div class="myaccount-table table-responsive text-center">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                <s:forEach var="logistic" items="${data.listLogistic}">
                                                	<tr>
                                                        <td>${logistic.id}</td>
                                                        ...
                                                        <td>${logistic.updatedate}</td>
                                                        <td><a href="receiveproduct" class="btn">Receive Product</a></td>
