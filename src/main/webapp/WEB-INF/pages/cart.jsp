...
function jia(btn) {
    ...
    var danjia = btn.parentNode.parentNode.getElementsByTagName("td")[2].innerHTML;
    jia.value++;
...
function sum() {
    ...
    for (var i = 0; i < jq.length; i++) {
        var q = jq[i].getElementsByTagName("td")[4];
                    ...
                    <div class="preheader-contact-info d-flex align-items-center justify-content-between justify-content-md-start">
                        <div class="single-contact-info">
                            ...
                            <a href="" class="contact-text">
                                <strong>Email:</strong> you@email.com
                            </a>
                        </div>
                        <div class="single-contact-info">
                            <span class="contact-icon">
...
<!--== End Page Breadcrumb ==-->
<c:form action="gotopay" method="get">
                ...
                <!-- Cart Table Area -->
                 <div class="cart-table table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody id="goods">
                        <s:forEach var="cart" items="${data.listCart}">
                        	<tr>
                            <td class="pro-thumbnail"><img alt="" src="${cart.img}"></td>
                            <td class="pro-title">${cart.pname}</td>
                            <td class="pro-price">${cart.price}</td>
                            <td class="pro-quantity">
                            	<input type="button" onclick="jian(this)" value="-"/><input type="text" style="width: 20px;background-color: white;text-align: center;" name="quant" value="1" disabled="disabled"/><input type="button" onclick="jia(this)" value="+"/>
                            </td>
                            <td class="pro-subtotal">${cart.price}</td>
                            <td class="pro-remove"><a href="deletefromcart?id=${cart.cid}"><i class="fa fa-trash-o"></i></a></td>
                        </tr>
                        </s:forEach>
                        ...
                        <tfoot>
                        	<tr>
                        		<td colspan="4" align="right"><span class="btn">Cart Total</span></td>
                        		<td>
                        			<input type="text" id="total" name="totalprice" style="background-color: white; width: 80%;text-align: center;"/>
                        		</td>
                        		<td></td>
                        	</tr>
