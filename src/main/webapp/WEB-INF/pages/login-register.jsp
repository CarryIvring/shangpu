            ...
            <div class="col-lg-12">
                <div class="page-breadcrumb">
                    <ul class="nav">
                        <li><a href="index">Home</a></li>
                        <li><a href="shop">Shop</a></li>
                        <li><a href="shop" class="active">Member Area</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="login-reg-form-wrap  pr-lg-50">
                        ...
                        <s:form action="CustomerLogin" method="post" modelAttribute="customer">
                            <div class="single-input-item">
                                <s:input path="username" placeholder="Username" required="required"/>
                            </div>

                            <div class="single-input-item">
                                <s:input path="password" placeholder="Password" required="required" />
                            </div>
                ...
                <div class="col-lg-7 mt-30 mt-lg-0">
                    <div class="login-reg-form-wrap">
                        <h2>Singup Form</h2>
                        <s:form action="CustomerRegister" method="post" modelAttribute="customer">
                        	<div class="single-input-item">
                                <s:input path="username" placeholder="Enter your Username" required="required" />
                            </div>

                            <div class="single-input-item">
                                <s:input path="email" placeholder="Enter your Email" required="required" />
                            </div>

                            <div class="single-input-item">
                                <s:input path="telephone" placeholder="Enter your telephone" required="required" />
                            </div>

                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="single-input-item">
                                        <s:input path="password" placeholder="Enter your Password" required="required" />
                                    </div>
                                </div>
								<div class="col-lg-6">
                                    <div class="single-input-item">
