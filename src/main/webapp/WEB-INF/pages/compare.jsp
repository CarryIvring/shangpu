                        ...
                        <table class="table table-bordered mb-0">
                            ...
                            <tr>
                                ...
                                <td class="product-image-title">
                                    <a href="single-product.jsp" class="image"><img class="img-fluid"
                                ...
                                <td class="product-image-title">
                                    ...
                                    <a href="single-product.jsp" class="title">Aquet Doren D 420</a>
                                </td>
                                <td class="product-image-title">
                                    <a href="single-product.jsp" class="image"><img class="img-fluid"
                            ...
                            <tr>
                                ...
                                <td><a href="cart.jsp" class="btn">Add to Cart</a></td>
                                <td><a href="cart.jsp" class="btn disabled">Add to Cart</a></td>
                                <td><a href="cart.jsp" class="btn">Add to Cart</a></td>
                            </tr>
                            <tr>
