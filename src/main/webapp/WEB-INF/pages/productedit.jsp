    ...
    <div class="container">
        <div class="member-area-from-wrap">
            <div class="row">
                ...
                <div class="col-lg-7 mt-30 mt-lg-0"  style="margin: 0 auto;">
                    <div class="login-reg-form-wrap">
                        <h2>Edit Product</h2>
                        <s:form action="SaveProductEdit" method="post" modelAttribute="product">
                        	<s:input path="date"/>
                        	<s:hidden path="id"/>
                            ...
                            <div class="single-input-item">
                            	<label class="required">Image Path</label>
                                <s:input path="img" />
                            </div>

                            <div class="single-input-item">
                            	<label class="required">SubImage Path</label>
                                <s:input path="sub_img" />
                            </div>
                            ...
                            <div class="single-input-item">
                            	<label class="required">Describe</label>
                                <s:input path="describe" />
                            </div>
